...
The BAM documentation describes the available models: [BAM models](https://bam.res.ibm.com/docs/models). Note that the GA watsonx.ai models are a much smaller subset of these currently consisting of: `flan-ul2-20b`, `starcoder-15.5b` `mt0-xxl-13b`, `gpt-neox-20b`, `flan-t5-xxl-11b`, `granite-13b-chat-v1`, `granite-13b-instruct-v1`, `mpt-7b-instruct2` and last but definitely not least `llama-2-70b-chat`. These are the most relevant ones to experiment with in this lab.
